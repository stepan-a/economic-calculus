...
\setbeamertemplate{footline}{
  {\hfill\vspace*{1pt}\href{http://creativecommons.org/licenses/by-sa/3.0/legalcode}{\ccbysa}\hspace{.1cm}
    ...
    \href{https://github.com/stepan-a/economic-calculus/blob/\HEAD/cours/chapitre-3.tex}{\gitrevision}\enspace--\enspace\today\enspace
  }}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=1]
          \begin{axis}[
            ...
            {sqrt(.5*x)-x} node[right] {\tiny $f(x)$} ;
            \node[above] at (.5,0) {\tiny{\color{black}$x^{\star}$}};
            \node[draw=black, circle, fill=black, scale=.25] at (.1,0.12360679774997896) {};
            \node[draw=black, circle, fill=black, scale=.25] at (.8,-0.16754446796632416) {};
            \node[below] at (.1,0) {\tiny $a_0$};
            \node[above] at (.8,0) {\tiny $b_0=b_1$};
            \node[left] at (0, 0.12360679774997896) {\tiny $f(a_0)$};
            \node[left] at (0, -0.16754446796632416) {\tiny $f(b_0)$};
            \addplot[draw=black, dashed] coordinates {(.1,0.12360679774997896) (0,0.12360679774997896)};
            \addplot[draw=black, dashed] coordinates {(.8,-0.16754446796632416) (0,-0.16754446796632416)};
            \addplot[draw=black, dashed] coordinates {(.1,0) (.1,0.12360679774997896)};
            \addplot[draw=black, dashed] coordinates {(.8,0) (.8,-0.16754446796632416)};
            \node[below] at (.45,0) {\tiny $a_1$};
            \addplot[draw=black, dashed] coordinates {(.45,0) (.45,0.024341649025256873)};
            \addplot[draw=black, dashed] coordinates {(.45,0.024341649025256873) (0,0.024341649025256873)};
            \node[left] at (0, 0.024341649025256873) {\tiny $f(a_1)$};
            \node[above] at (.625,0) {\tiny $b_2$};
            \addplot[draw=black, dashed] coordinates {(.625,0) (.625,-0.06598300562505255)};
            \addplot[draw=black, dashed] coordinates {(.625,-0.06598300562505255) (0,-0.06598300562505255)};
            \node[left] at (0, -0.06598300562505255) {\tiny $f(b_2)$};
            \addplot[draw=red,dotted] coordinates {(0.1,-.2) (0.1,0)};
            \draw[{[-]}, thick, red] (0.1,-.2) -- (0.8,-0.2);
            \addplot[draw=red,dotted] coordinates {(0.45,-.35) (0.45,0)};
            \addplot[draw=red,dotted] coordinates {(0.8,-0.25) (0.8,0)};
            \node[left] at (0.06,-0.2) {\tiny\color{red} intervalle 0};
            \draw[{[-]}, thick, red] (0.45,-.25) -- (0.8,-0.25);
            \node[left] at (0.06,-0.25) {\tiny\color{red} intervalle 1};
            \addplot[draw=red,dotted] coordinates {(0.625,-0.3) (0.625,0)};
            \draw[{[-]}, thick, red] (0.45,-.3) -- (0.625,-0.3);
            \node[left] at (0.06,-0.30) {\tiny\color{red} intervalle 2};
            % \node[above] at (.5375,0) {\tiny $b_3$};
            \addplot[draw=red,dotted] coordinates {(0.5375,-0.35) (0.5375,0)};
            \draw[{[-]}, thick, red] (0.45,-.35) -- (0.5375,-0.35);
            \node[left] at (0.06,-0.35) {\tiny\color{red} intervalle 3};
          \end{axis}
        \end{tikzpicture}
      \end{center}
    \end{column}
...
\begin{frame}
  \frametitle{Fonctions continues}
  \framesubtitle{Retour sur les équations récurrentes (b)}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.6]
      \begin{axis}[
        ...
        {sqrt(.5*x)} node[right] {\tiny \color{blue} $f(x)+x = g(x)$};
        \addplot[
        draw=blue,
        smooth,
        samples=2,
        ...
        {x} ;
        \node[below] at (.5,0) {\tiny{\color{black}$x^{\star}$}};
        \addplot[draw=black, dashed] coordinates {(.5,0) (.5,.5)};
        \node[draw=black, circle, fill=black, scale=.25] at (.5,0) {};
        \node[draw=blue, circle, fill=blue, scale=.25] at (.5,.5) {};
        \node[below] at (.1,0) {\tiny{\color{red}$x_0$}};
        \addplot[draw=red] coordinates {(.1,0) (.1, 0.22360679774997896)};
        \addplot[draw=red] coordinates {(.1, 0.22360679774997896) (0.22360679774997896, 0.22360679774997896)};
        \node[below] at (0.22360679774997896,0) {\tiny{\color{red}$x_1$}};
        \addplot[draw=red] coordinates {(0.22360679774997896,0.22360679774997896) (0.22360679774997896, 0.334370152488211)};
        \addplot[draw=red,dotted] coordinates {(0.22360679774997896,0) (0.22360679774997896,0.22360679774997896)};
        \addplot[draw=red] coordinates {(0.22360679774997896, 0.334370152488211) (0.334370152488211, 0.334370152488211)};
        \node[below] at (0.334370152488211,0) {\tiny{\color{red}$x_2$}};
        \addplot[draw=red] coordinates {(0.334370152488211,0.334370152488211) (0.334370152488211, 0.4088827169789713)};
        \addplot[draw=red,dotted] coordinates {(0.334370152488211,0) (0.334370152488211,0.4088827169789713)};
        \addplot[draw=red] coordinates {(0.334370152488211, 0.4088827169789713) (0.4088827169789713, 0.4088827169789713)};
        
        \node[below] at (0.4088827169789713,0) {\tiny{\color{red}$x_3$}};
        \addplot[draw=red,dotted] coordinates {(0.4088827169789713,0) (0.4088827169789713,0.4088827169789713)};
        \addplot[draw=red] coordinates {(0.4088827169789713,0.4088827169789713) (0.4088827169789713, 0.4521519197012058)};
        \addplot[draw=red] coordinates {(0.4088827169789713, 0.4521519197012058)  (0.4521519197012058, 0.4521519197012058)};
        \addplot[draw=red, dotted] coordinates {(0.4521519197012058, 0.4521519197012058)  (0.4521519197012058, 0)};
        \addplot[draw=red] coordinates {(0.4521519197012058, 0.4521519197012058) (0.4521519197012058, 0.4754744576216507)};
        \addplot[draw=red] coordinates {(0.4521519197012058, 0.4754744576216507) (0.4754744576216507, 0.4754744576216507)};
        \addplot[draw=red, dotted] coordinates {(0.4754744576216507, 0.4754744576216507) (0.4754744576216507, 0)};
        \node[right] at (0.1, -.25) {\tiny\color{red} $x_{n+1} = g(x_n)$} ;
        \node[right] at (0.1, -.4) {\tiny\color{red} $\lim_{n\rightarrow\infty}x_{n} = x^{\star}$} ;
      \end{axis}
    \end{tikzpicture}
  \end{center}
