...
\begin{frame}
  ...
  \begin{definition}
    La fonction $f(x)$ admet la limite $\ell<\infty$ lorsque $x$ tend vers l'infini pour tout $\varepsilon>0$, l existe $\eta>0$ tel que $|f(x)-\ell|<\varepsilon$ dès que $x>\nu$. On écrit alors~:
    \[
  ...
  \item La fonction $f$ converge vers $\ell$ si on peut rendre la distance entre $f(x)$ et $\ell$ arbitrairement petite quand $x$ s'accroît.\newline

  \end{itemize}

  \begin{definition}
    La fonction $f(x)$ admet la limite $\ell<\infty$ lorsque $x$ tend vers moins l'infini pour tout $\varepsilon>0$, l existe $\eta>0$ tel que $|f(x)-\ell|<\varepsilon$ dès que $x<\nu$. On écrit alors~:
    \[
      \lim_{x\rightarrow\infty} f(x) = \ell
    \]
  \end{definition}
