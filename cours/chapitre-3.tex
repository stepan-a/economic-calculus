...
\begin{frame}
  ...
  Une fonction peut ne pas converger vers une limite finie et ne pas diverger vers l'infini. C'est le cas des fonctions périodidiques, comme la fonction $\sin (x)$~:
