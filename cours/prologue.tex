...
\CatchFileDef{\HEAD}{../.git/refs/heads/master}{\endlinechar=-1}
...
\setbeamertemplate{footline}{
  {\hfill\vspace*{1pt}\href{http://creativecommons.org/licenses/by-sa/3.0/legalcode}{\ccbysa}\hspace{.1cm}
    \raisebox{-.075cm}{\href{https://git.adjemian.eu/University/economic-calculus}{\includegraphics[scale=.1]{../img/gitlab.png}}}\quad
    \href{https://git.adjemian.eu/University/economic-calculus/-/blob/\HEAD/cours/prologue.tex}{\gitrevision}\quad\today
  }\hspace{1cm}}
