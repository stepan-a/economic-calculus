...
\raisebox{-.075cm}{\href{https://mnemosyne.adjemian.eu/stepan-a/economic-calculus/cours}{\includegraphics[scale=.1]{../img/gitlab.png}}}
}\hspace{1cm}}
...
% \newenvironment{notes}
% {\adjustbox{valign=T}\bgroup\justifying\bgroup\tiny\begin{spacing}{1.0}
...
\institute{\texttt{stepan@adjemian.io}} \date{Septembre 2018}
