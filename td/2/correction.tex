...
\institute{\texttt{stephane.adjemian@univ-lemans.fr}} \date{Septembre 2022}
...
\begin{frame}
  ...
  \item[Remarque] En postulant un polynôme d'ordre 1 nous ne trouverions pas de solution, en postulant un polynôme d'ordre supérieur nous obtiendrions des coefficients nuls au delà de l'ordre deux.
