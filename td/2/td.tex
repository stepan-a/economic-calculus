...
\exercice Sans calculer le discriminant, montrer que l'équation
...
\exercice Représenter graphiquement à l'aide d'un tableur les
fonctions suivantes :
\begin{enumerate}[(i)]
...
\exercice Soit un ménage disposant d'un revenu de 100. On suppose
...
\exercice Supposons que l'on puisse
...
\exercice On reprend les exercices 9 et 10 en supposant que $p_B =
