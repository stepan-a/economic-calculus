...
\exercice Soit la suite de terme général $u_n = \rho u_{n-1}$ pour
...
\exercice La suite de terme général $u_n = \frac{(-1)^{n+1}}{n^2}$
est-elle monotone ? Montrer que cette suite admet 0 pour limite.

\bigskip

\exercice Sur un marché l'offre et la demande sont caractérisées
par :
\[
\begin{split}
  S(p): &\quad q = 1+p\\
